...
<html>
				...
				if($("#ff").form('validate')){
					$.ajax({   
					     ...
					     success:function(data){   
					        if(data.msg==null){
					        	window.location="${pageContext.request.contextPath}/sys/scheduleJob/toList.do";
					        }else{
	...
	<body>
		<form id="ff" action="${pageContext.request.contextPath}/sys/scheduleJob/add.do" method="POST">
			<table>
				...
				<tr>
					<td>className:</td>
					<td><input type="text" name="className" value="com.wangsong.sys.util.TaskA"  class="easyui-textbox" required="true" validType="length[1,50]"></td>
				</tr>
