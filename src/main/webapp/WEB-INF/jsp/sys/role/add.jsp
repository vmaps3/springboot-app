		...
		<form id="ff" action="${pageContext.request.contextPath}/sys/role/add.do" method="POST">
			<table>
				...
				<tr>
					<td>resources:</td>
					<td>
						<input name="resourcesId" required="true" class="easyui-combotree" cascadeCheck ="false" data-options="url:'${pageContext.request.contextPath}/sys/resources/list.do'" multiple >
