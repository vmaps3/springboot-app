...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			$(function(){ 
				$.ajax({   
				     url:'${pageContext.request.contextPath}/system/resources/selectByPrimaryKey.do',   
				     type:'post',   
				     data:'id=${id}',
				     success:function(data){   
				    	 $('#ff').form('load',data);
	...
	<body>
		<form id="ff" action="${pageContext.request.contextPath}/system/resources/update.do" method="POST">
